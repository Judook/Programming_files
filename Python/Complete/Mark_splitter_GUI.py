...
def set_location() :
    try :
        ...
        mark_list = openpyxl.load_workbook(location_text.get())
...
big_title = tkinter.Label(window, text = "Mark Splitter", font = ("Algerian", 25), foreground = "green", background = "#1a1a1a")

location_label = tkinter.Label(window, text = "Enter the file location of the .xlsx file", font = ("Arial", 15), background = "#1a1a1a", foreground = "white")
location_text = tkinter.Entry(window, width = 450, font = ("Arial", 15), borderwidth = 0, background = "#363636", foreground = "white")
...
location_label.pack()
location_text.pack(padx = 10, pady = 10)
